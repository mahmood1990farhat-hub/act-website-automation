...
export default function PricingTiers({
  ...
  const handleEdit = (tier: PricingTier) => {
    ...
    reset({
      vehicle_type_id: tier.vehicle_type.id,
            ...
            <tbody>
              {tiers.map((tier) => (
                ...
                >
                  ...
                  <td className="py-3 px-4 text-foreground">{tier.order}</td>
              ...
              <div>
                ...
                <select
                  {...register("vehicle_type_id", {
                    required: trans.tiers?.vehicleTypeRequired || "Vehicle type is required",
                    valueAsNumber: true,
                    validate: (value) => value > 0 || trans.tiers?.vehicleTypeRequired || "Please select a vehicle type",
                  })}
                ...
                >
                  <option value={0}>
                    {trans.tiers?.selectVehicleType || "Select vehicle type..."}
                  </option>
                  {vehicleTypes.map((vt) => (
              ...
              <div>
                ...
                <input
                  ...
                  {...register("order", {
                    ...
                    valueAsNumber: true,
                    min: { value: 0, message: trans.tiers?.orderMin || "Order must be 0 or greater" },
                  })}
                  className="w-full p-3 border-2 border-border rounded-lg bg-background text-foreground focus:outline-none focus:border-primary transition-colors"
                />
                {errors.order && (
                  <p className="text-error text-sm mt-1">{errors.order.message}</p>
                )}
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  {...register("min_distance_miles", {
                    required: trans.tiers?.minDistanceRequired || "Min distance is required",
                    pattern: {
                      value: /^\d+(\.\d{1,2})?$/,
                      message: trans.tiers?.minDistanceInvalid || "Invalid distance format",
                    },
                  })}
                  placeholder="0.00"
                  className="w-full p-3 border-2 border-border rounded-lg bg-background text-foreground focus:outline-none focus:border-primary transition-colors"
              ...
              <div>
                ...
                <input
                  ...
                  {...register("max_distance_miles", {
                    required: trans.tiers?.maxDistanceRequired || "Max distance is required",
                    pattern: {
                      value: /^\d+(\.\d{1,2})?$/,
                      message: trans.tiers?.maxDistanceInvalid || "Invalid distance format",
                    },
                  })}
                  placeholder="10.00"
                  className="w-full p-3 border-2 border-border rounded-lg bg-background text-foreground focus:outline-none focus:border-primary transition-colors"
              ...
              <div>
                ...
                <input
                  ...
                  {...register("rate_per_mile", {
                    required: trans.tiers?.ratePerMileRequired || "Rate per mile is required",
                    pattern: {
                      value: /^\d+(\.\d{1,2})?$/,
                      message: trans.tiers?.ratePerMileInvalid || "Invalid rate format",
                    },
                  })}
                  placeholder="2.50"
                  className="w-full p-3 border-2 border-border rounded-lg bg-background text-foreground focus:outline-none focus:border-primary transition-colors"
