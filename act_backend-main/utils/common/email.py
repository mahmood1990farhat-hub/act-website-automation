...
def _absolute_app_url(relative_url: str) -> str:
    """Absolute URL for paths like FileField.url (e.g. /media/...), for email clients."""
    if not relative_url:
        return ""
...
def send_trip_accepted_to_passenger(
    ...
    try:
        ...
        if is_guest_driver and guest_driver_info:
            ...
            driver_pco_url = (
                _absolute_app_url(pco_file.url)
        ...
        context = {
            ...
            "adults_count": getattr(trip, "adults_count", 0) or 0,
            "kids_count": getattr(trip, "kids_count", 0) or 0,
            "infants_count": getattr(trip, "infants_count", 0) or 0,
            "pets_count": getattr(trip, "pets_count", 0) or 0,
            "wheelchairs_count": getattr(trip, "wheelchairs_count", 0) or 0,
            "support_phone_primary": "+44 7464 940000",
            "support_phone_secondary": "+44 20 8153 0303",
            "support_email": "info@airportandcitytransfer.com",
...
def send_passenger_trip_cancellation_to_passenger(user, trip, refund_message: str = "") -> None:
    ...
    try:
        ...
        context = {
            ...
            "app_store_badge_url": _email_asset_url("trip_accepted/apple.png"),
            "footer_logo_image_url": _email_asset_url("trip_accepted/footer-logo.png"),
            "download_cancellation_url": (
                _absolute_app_url(trip.cancellation_confirmation_pdf.url)
