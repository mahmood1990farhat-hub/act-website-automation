...
export default function Footer({ footer ,faqs ,terms ,privacyPolicy, locale = "en" as languageType }: typeProps) {
  ...
  <Link
    href={process.env.NEXT_PUBLIC_FACEBOOK_REVIEW_URL || "https://www.facebook.com"}
    target="_blank"
  >
  ...
  <Link
    href={process.env.NEXT_PUBLIC_INSTAGRAM_REVIEW_URL || "https://www.instagram.com"}
    target="_blank"
  >
  ...
  <Link
    href={process.env.NEXT_PUBLIC_TWITTER_REVIEW_URL || "https://www.twitter.com"}
    target="_blank"
  >
  ...
  <Link
    href={process.env.NEXT_PUBLIC_LINKEDIN_REVIEW_URL || "https://www.linkedin.com"}
    target="_blank"
  >
