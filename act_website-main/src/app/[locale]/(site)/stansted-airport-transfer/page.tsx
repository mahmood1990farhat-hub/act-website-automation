...
export default function StanstedAirportTransferPage() {
    ...
    "@type": "Service",
    name: "Stansted Airport Transfer London",
    ...
    url: "https://airportandcitytransfer.com/en/stansted-airport-transfer",
    description:
      "Private Stansted airport transfer service across London with fixed pricing, professional drivers, executive vehicles, flight monitoring and 24/7 booking.",
  };
  return (
