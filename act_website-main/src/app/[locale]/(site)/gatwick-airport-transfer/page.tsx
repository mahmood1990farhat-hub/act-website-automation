...
const pageMetadata: Metadata = {
  title: "Gatwick Airport Transfer London | Airport & City Transfer",
  description:
    "Reliable private Gatwick airport transfers across London with fixed pricing, professional drivers, executive vehicles, flight monitoring and 24/7 booking.",
};
...
export async function generateMetadata({
  ...
  return getPublicPageSeo(locale, "gatwick-airport-transfer", pageMetadata);
}
...
const routes = [
  ...
  "Gatwick to Mayfair",
  "Gatwick to London hotels",
  "Gatwick to Heathrow Airport",
  "Gatwick to business districts",
];

const faqs = [
  {
    q: "Do you provide Gatwick airport pickup?",
    a: "Yes. Airport & City Transfer provides private Gatwick airport pickup and drop-off services across London.",
  },
  {
  ...
  {
    q: "Can I book a 7 seater from Gatwick?",
...
export default function GatwickAirportTransferPage() {
    ...
    "@type": "Service",
    name: "Gatwick Airport Transfer London",
  ...
  return (
    <main className="bg-black text-white">
      ...
      <section className="px-6 py-20 md:px-12 lg:px-20">
        <div className="mx-auto max-w-6xl">
          ...
          <h1 className="max-w-4xl text-4xl font-bold leading-tight md:text-6xl">
            Gatwick Airport Transfer London
          </h1>

          <p className="mt-6 max-w-3xl text-lg text-gray-300">
            Book a reliable private Gatwick airport transfer across London with
      ...
      <section className="px-6 py-14 md:px-12 lg:px-20">
        <div className="mx-auto max-w-6xl">
          <h2 className="text-3xl font-semibold">Popular Gatwick Routes</h2>
      ...
      <section className="px-6 py-14 md:px-12 lg:px-20">
        <div className="mx-auto max-w-4xl">
          <h2 className="text-3xl font-semibold">
            Private Gatwick Airport Transfer Service
          </h2>

          <div className="mt-6 space-y-5 text-gray-300">
            <p>
              Airport & City Transfer provides private Gatwick airport transfer
            ...
            <p>
              Our Gatwick transfer service is designed for convenience. You can
      ...
      <section className="px-6 py-20 md:px-12 lg:px-20">
        <div className="mx-auto max-w-5xl rounded-3xl border border-yellow-500/30 bg-zinc-900 p-10 text-center">
          <h2 className="text-3xl font-bold">
            Book Your Gatwick Airport Transfer Today
          </h2>

          <p className="mx-auto mt-4 max-w-2xl text-gray-300">
            Pre-book your Gatwick airport transfer with Airport & City Transfer
