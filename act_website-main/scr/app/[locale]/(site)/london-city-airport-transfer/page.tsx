...
export const metadata: Metadata = {
  title: "London City Airport Transfer | Airport & City Transfer",
  description:
    "Reliable private London City Airport transfers across London with fixed pricing, professional drivers, executive vehicles, flight monitoring and 24/7 booking.",
};
...
const routes = [
  ...
  "London City Airport to Mayfair",
  "London City Airport to London hotels",
  "London City Airport to Heathrow Airport",
  "London City Airport to business districts",
];

const faqs = [
  {
    q: "Do you provide London City Airport pickup?",
    a: "Yes. Airport & City Transfer provides private London City Airport pickup and drop-off services across London.",
  },
  {
  ...
  {
    q: "Can I book an executive car from London City Airport?",
    a: "Yes. You can book executive, luxury, standard, 7 seater, and luxury van transfers from London City Airport.",
  },
  {
...
export default function LondonCityAirportTransferPage() {
  ...
  return (
    <main className="bg-black text-white">
      ...
      <section className="px-6 py-20 md:px-12 lg:px-20">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mt-6 max-w-3xl text-lg text-gray-300">
            Book a reliable private London City Airport transfer across London
            with fixed pricing, professional drivers, executive vehicles, flight
      ...
      <section className="px-6 py-14 md:px-12 lg:px-20">
        <div className="mx-auto max-w-6xl">
          <h2 className="text-3xl font-semibold">Popular London City Airport Routes</h2>
      ...
      <section className="px-6 py-14 md:px-12 lg:px-20">
        <div className="mx-auto max-w-4xl">
          <h2 className="text-3xl font-semibold">
            Private London City Airport Transfer Service
          </h2>

          <div className="mt-6 space-y-5 text-gray-300">
            <p>
              Airport & City Transfer provides private London City Airport
              transfer services for passengers travelling to and from London.
              Whether you are arriving for business, a hotel stay, a conference,
              or an executive journey, ACT helps you pre-book a comfortable and
              reliable transfer.
            </p>

            <p>
              Our London City Airport transfer service is designed for business
              travellers, families, tourists, and professionals who want a smooth
              journey from the airport to their final destination. You can choose
              from standard private hire vehicles, executive cars, luxury
              vehicles, 7 seaters, and luxury vans.
            </p>
      ...
      <section className="px-6 py-20 md:px-12 lg:px-20">
        <div className="mx-auto max-w-5xl rounded-3xl border border-yellow-500/30 bg-zinc-900 p-10 text-center">
          <h2 className="text-3xl font-bold">
            Book Your London City Airport Transfer Today
          </h2>

          <p className="mx-auto mt-4 max-w-2xl text-gray-300">
            Pre-book your London City Airport transfer with Airport & City
            Transfer and travel across London with confidence.
          </p>
