...
const routes = [
  ...
  "Heathrow to business districts",
];

const faqs = [
  {
    q: "Do you provide Heathrow airport pickup?",
    a: "Yes. Airport & City Transfer provides private Heathrow airport pickup and drop-off services across London.",
  },
  {
  ...
  {
    q: "Can I book a 7 seater from Heathrow?",
...
export default function HeathrowAirportTransferPage() {
   const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Heathrow Airport Transfer London",
    ...
    url: "https://airportandcitytransfer.com/en/heathrow-airport-transfer",
    description:
      "Private Heathrow airport transfer service across London with fixed pricing, professional drivers, executive vehicles, flight monitoring and 24/7 booking.",
  };
  return (
    <main className="bg-black text-white">
      ...
      <section className="px-6 py-20 md:px-12 lg:px-20">
        <div className="mx-auto max-w-6xl">
          ...
          <h1 className="max-w-4xl text-4xl font-bold leading-tight md:text-6xl">
            Heathrow Airport Transfer London
          </h1>

          <p className="mt-6 max-w-3xl text-lg text-gray-300">
            Book a reliable private Heathrow airport transfer across London with
      ...
      <section className="px-6 py-14 md:px-12 lg:px-20">
        <div className="mx-auto max-w-6xl">
          <h2 className="text-3xl font-semibold">Popular Heathrow Routes</h2>
      ...
      <section className="px-6 py-14 md:px-12 lg:px-20">
        <div className="mx-auto max-w-4xl">
          <h2 className="text-3xl font-semibold">
            Private Heathrow Airport Transfer Service
          </h2>

          <div className="mt-6 space-y-5 text-gray-300">
            <p>
              Airport & City Transfer provides private Heathrow airport transfer
            ...
            <p>
              Our Heathrow transfer service is designed for convenience. You can
      ...
      <section className="px-6 py-20 md:px-12 lg:px-20">
        <div className="mx-auto max-w-5xl rounded-3xl border border-yellow-500/30 bg-zinc-900 p-10 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-gray-300">
            Pre-book your Heathrow airport transfer with Airport & City Transfer
