...
export const metadata: Metadata = {
  title: "Luton Airport Transfer London | Airport & City Transfer",
  description:
    "Reliable private Luton airport transfers across London with fixed pricing, professional drivers, executive vehicles, flight monitoring and 24/7 booking.",
};
...
const routes = [
  ...
  "Luton to Canary Wharf",
  "Luton to Mayfair",
  "Luton to London hotels",
  "Luton to Heathrow Airport",
  "Luton to business districts",
];

const faqs = [
  {
    q: "Do you provide Luton airport pickup?",
    a: "Yes. Airport & City Transfer provides private Luton airport pickup and drop-off services across London.",
  },
  {
  ...
  {
    q: "Can I book a 7 seater from Luton?",
...
export default function LutonAirportTransferPage() {
    const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Luton Airport Transfer London",
    ...
    url: "https://airportandcitytransfer.com/en/luton-airport-transfer",
    description:
      "Private Luton airport transfer service across London with fixed pricing, professional drivers, executive vehicles, flight monitoring and 24/7 booking.",
  };
  return (
    <main className="bg-black text-white">
      ...
      <section className="px-6 py-20 md:px-12 lg:px-20">
        <div className="mx-auto max-w-6xl">
          ...
          <h1 className="max-w-4xl text-4xl font-bold leading-tight md:text-6xl">
            Luton Airport Transfer London
          </h1>

          <p className="mt-6 max-w-3xl text-lg text-gray-300">
            Book a reliable private Luton airport transfer across London with
      ...
      <section className="px-6 py-14 md:px-12 lg:px-20">
        <div className="mx-auto max-w-6xl">
          <h2 className="text-3xl font-semibold">Popular Luton Routes</h2>
      ...
      <section className="px-6 py-14 md:px-12 lg:px-20">
        <div className="mx-auto max-w-4xl">
          <h2 className="text-3xl font-semibold">
            Private Luton Airport Transfer Service
          </h2>

          <div className="mt-6 space-y-5 text-gray-300">
            <p>
              Airport & City Transfer provides private Luton airport transfer
            ...
            <p>
              Our Luton transfer service is designed for convenience. You can
      ...
      <section className="px-6 py-20 md:px-12 lg:px-20">
        <div className="mx-auto max-w-5xl rounded-3xl border border-yellow-500/30 bg-zinc-900 p-10 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-gray-300">
            Pre-book your Luton airport transfer with Airport & City Transfer
